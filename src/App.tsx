...
function App() {
  ...
  return (
    <section className="section">
      ...
      {isOpen && (
        <ModalDialog onClose={toggleModal}>
          <header>Modal como los grandes</header>
          <body>
            <div className="content">
              ...
              <p>
                ...
                <a href="codig0latino.com">non ante</a>. Phasellus lacus ex,
                semper ac tortor nec, fringilla condimentum orci. Fusce eu
                rutrum tellus.
              </p>
              <ol>
